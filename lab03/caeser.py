...
# Form implementation generated from reading ui file 'caeser.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(260, 20, 291, 161))
        font = QtGui.QFont()
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(240, 170, 341, 41))
        font = QtGui.QFont()
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(240, 360, 341, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.txt_cipher_text.setFont(font)
        self.txt_cipher_text.setPlainText("")
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(240, 260, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2.setGeometry(QtCore.QRect(120, 170, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_3.setGeometry(QtCore.QRect(120, 270, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(120, 370, 111, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_en.setGeometry(QtCore.QRect(240, 440, 71, 51))
        self.btn_en.setObjectName("btn_en")
        self.btn_de = QtWidgets.QToolButton(self.centralwidget)
        self.btn_de.setGeometry(QtCore.QRect(400, 440, 71, 51))
